...
class Queue:private list<T>{
	public:
		...
		void enqueue(const T& value){  list<T>::push_back(value); }
		void dequeue(){ list<T>::pop_front(); }
		T front()const{ return list<T>::front(); }
		T back()const{ return list<T>::back(); }
...
class Queue2{
	...
	public:
		...
		void dequeue(){ container.pop_front(); }
		T front()const{ return container.front(); }
		T back()const{ return container.back(); }
